...
| Component | [vtune profiling](tutorial_vtune_profiling.ipynb) | This Jupyter Notebook demonstrates how to use VTune Profiler to profile oneDNN samples and find out performance bottlenecks. |
